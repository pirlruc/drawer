...
namespace improc 
{
    class IMPROC_EXPORTS DrawerLogger : public LoggerSingleton<DrawerLogger>
    {
        ...
        private:
            ...
            DrawerLogger(const std::shared_ptr<spdlog::logger>& logger) : LoggerSingleton(std::move(logger)) {}
