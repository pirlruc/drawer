 ...
 */
cv::Mat improc::ImageFileDrawer::Draw(const std::optional<improc::DrawerVariant>&)
{
 ...
 */
bool improc::ImageFileDrawer::Verify(const cv::Mat& drawer_output, const std::optional<improc::DrawerVariant>&)
{
